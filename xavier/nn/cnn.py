...
def cnn(filename, name_type, model_type=Type.cnn, learning_rate=0.0004, times=3, num_epoch=5, batch_size=128,
    ...
    model = Model(filename=filename, name_type=name_type, learning_rate=learning_rate,
                  ...
                  input_layer=input_layer, matriz_size=matriz_size, output_layer=output_layer, model_type=model_type)
